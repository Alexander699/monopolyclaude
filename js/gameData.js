...
// 22 cities across 8 alliances, 4 special, 6 cards, 2 tax, 4 transport, 2 infrastructure
...
export const BOARD = [
  ...
  { id: 8, type: 'country', name: 'Alexandria', alliance: 'AFRICAN_RISING', price: 1000, flag: '🇪🇬', resource: 'oil', rents: [40, 80, 220, 600, 800, 1100] },
  { id: 9, type: 'country', name: 'Giza', alliance: 'AFRICAN_RISING', price: 1200, flag: '🇪🇬', resource: 'tourism', rents: [50, 100, 300, 750, 950, 1300] },
  { id: 10, type: 'special', subtype: 'sanctions', name: 'Trade Sanctions', icon: '⛔' },

  // === LEFT COLUMN (positions 11-20) ===
  { id: 11, type: 'country', name: 'Cairo', alliance: 'AFRICAN_RISING', price: 1200, flag: '🇪🇬', resource: 'tourism', rents: [50, 100, 300, 750, 950, 1300] },
  { id: 12, type: 'infrastructure', name: 'Internet Backbone', price: 1500, icon: '🌐' },
  { id: 13, type: 'country', name: 'Salvador', alliance: 'BRICS', price: 1400, flag: '🇧🇷', resource: 'tourism', rents: [55, 110, 330, 800, 1050, 1400] },
  ...
  { id: 16, type: 'country', name: 'Mumbai', alliance: 'SOUTH_ASIAN', price: 1400, flag: '🇮🇳', resource: 'agriculture', rents: [55, 110, 330, 800, 1050, 1400] },
  { id: 17, type: 'card', subtype: 'diplomaticCable', name: 'Diplomatic Cable', icon: '📜' },
  { id: 18, type: 'country', name: 'Madhya Pradesh', alliance: 'SOUTH_ASIAN', price: 1600, flag: '🇮🇳', resource: 'tourism', rents: [65, 130, 400, 950, 1150, 1500] },
  { id: 19, type: 'country', name: 'Bengaluru', alliance: 'SOUTH_ASIAN', price: 1200, flag: '🇮🇳', resource: 'tourism', rents: [50, 100, 300, 750, 950, 1300] },
  ...
  { id: 24, type: 'country', name: 'Lyon', alliance: 'EU', price: 2400, flag: '🇫🇷', resource: 'tech', rents: [90, 180, 540, 1200, 1500, 2000] },
  { id: 25, type: 'transport', name: 'Air Routes', price: 2000, icon: '✈️', rents: [250, 500, 1000, 2000] },
  { id: 26, type: 'country', name: 'Tel Aviv', alliance: 'ASIAN_TIGERS', price: 2800, flag: '🇮🇱', resource: 'tech', rents: [110, 220, 660, 1500, 1800, 2400] },
  { id: 27, type: 'country', name: 'Haifa', alliance: 'ASIAN_TIGERS', price: 2600, flag: '🇮🇱', resource: 'tech', rents: [100, 200, 600, 1400, 1700, 2200] },
  { id: 28, type: 'infrastructure', name: 'Shipping Lanes', price: 1500, icon: '⚓' },
  { id: 29, type: 'country', name: 'Rio', alliance: 'BRICS', price: 3000, flag: '🇧🇷', resource: 'tech', rents: [120, 240, 720, 1600, 2000, 2600] },
  { id: 30, type: 'special', subtype: 'incident', name: 'International Incident', icon: '🚨' },

  // === RIGHT COLUMN (positions 31-39) ===
  { id: 31, type: 'country', name: 'Sao Paulo', alliance: 'BRICS', price: 2800, flag: '🇧🇷', resource: 'agriculture', rents: [110, 220, 660, 1500, 1800, 2400] },
  { id: 32, type: 'country', name: 'Jerusalem', alliance: 'ASIAN_TIGERS', price: 2600, flag: '🇮🇱', resource: 'tech', rents: [100, 200, 600, 1400, 1700, 2200] },
  { id: 33, type: 'card', subtype: 'diplomaticCable', name: 'Diplomatic Cable', icon: '📜' },
  { id: 34, type: 'country', name: 'Dubai', alliance: 'OIL_NATIONS', price: 3200, flag: '🇦🇪', resource: 'oil', rents: [130, 260, 780, 1800, 2200, 2800] },
  { id: 35, type: 'transport', name: 'Digital Networks', price: 2000, icon: '📡', rents: [250, 500, 1000, 2000] },
  { id: 36, type: 'country', name: 'New York', alliance: 'AMERICAS', price: 3200, flag: '🇺🇸', resource: 'agriculture', rents: [130, 260, 780, 1800, 2200, 2800] },
  { id: 37, type: 'country', name: 'Abu Dhabi', alliance: 'OIL_NATIONS', price: 3400, flag: '🇦🇪', resource: 'oil', rents: [140, 280, 840, 1900, 2400, 3000] },
...
export const BOARD_EXPANDED = [
  ...
  { id: 8, type: 'country', name: 'Alexandria', alliance: 'AFRICAN_RISING', price: 1000, flag: '🇪🇬', resource: 'oil', rents: [40, 80, 220, 600, 800, 1100] },
  { id: 9, type: 'country', name: 'Giza', alliance: 'AFRICAN_RISING', price: 1200, flag: '🇪🇬', resource: 'tourism', rents: [50, 100, 300, 750, 950, 1300] },
  { id: 10, type: 'country', name: 'Chicago', alliance: 'AMERICAS', price: 1100, flag: '🇺🇸', resource: 'oil', rents: [45, 90, 260, 700, 880, 1200] },
  { id: 11, type: 'country', name: 'Auckland', alliance: 'PACIFIC_ISLANDS', price: 900, flag: '🇳🇿', resource: 'tourism', rents: [35, 70, 200, 550, 750, 1050] },
  { id: 12, type: 'special', subtype: 'sanctions', name: 'Trade Sanctions', icon: '⛔' },

  // === LEFT COLUMN (positions 13-24) ===
  { id: 13, type: 'country', name: 'Cairo', alliance: 'AFRICAN_RISING', price: 1200, flag: '🇪🇬', resource: 'tourism', rents: [50, 100, 300, 750, 950, 1300] },
  { id: 14, type: 'infrastructure', name: 'Internet Backbone', price: 1500, icon: '🌐' },
  { id: 15, type: 'country', name: 'Rio', alliance: 'BRICS', price: 1400, flag: '🇧🇷', resource: 'tourism', rents: [55, 110, 330, 800, 1050, 1400] },
  ...
  { id: 18, type: 'country', name: 'Mumbai', alliance: 'SOUTH_ASIAN', price: 1400, flag: '🇮🇳', resource: 'agriculture', rents: [55, 110, 330, 800, 1050, 1400] },
  { id: 19, type: 'card', subtype: 'diplomaticCable', name: 'Diplomatic Cable', icon: '📜' },
  { id: 20, type: 'country', name: 'Madhya Pradesh', alliance: 'SOUTH_ASIAN', price: 1600, flag: '🇮🇳', resource: 'tourism', rents: [65, 130, 400, 950, 1150, 1500] },
  { id: 21, type: 'country', name: 'Bengaluru', alliance: 'SOUTH_ASIAN', price: 1200, flag: '🇮🇳', resource: 'tourism', rents: [50, 100, 300, 750, 950, 1300] },
  ...
  { id: 25, type: 'country', name: 'Paris', alliance: 'EU', price: 2200, flag: '🇫🇷', resource: 'tourism', rents: [85, 170, 500, 1100, 1400, 1800] },
  { id: 26, type: 'card', subtype: 'globalNews', name: 'Global News', icon: '📰' },
  { id: 27, type: 'country', name: 'Toulouse', alliance: 'EU', price: 2400, flag: '🇫🇷', resource: 'tech', rents: [90, 180, 540, 1200, 1500, 2000] },
  { id: 28, type: 'country', name: 'Lyon', alliance: 'EU', price: 2400, flag: '🇫🇷', resource: 'tech', rents: [90, 180, 540, 1200, 1500, 2000] },
  { id: 29, type: 'transport', name: 'Air Routes', price: 2000, icon: '✈️', rents: [250, 500, 1000, 2000] },
  { id: 30, type: 'country', name: 'Tel Aviv', alliance: 'ASIAN_TIGERS', price: 2800, flag: '🇮🇱', resource: 'tech', rents: [110, 220, 660, 1500, 1800, 2400] },
  { id: 31, type: 'country', name: 'Haifa', alliance: 'ASIAN_TIGERS', price: 2600, flag: '🇮🇱', resource: 'tech', rents: [100, 200, 600, 1400, 1700, 2200] },
  { id: 32, type: 'infrastructure', name: 'Shipping Lanes', price: 1500, icon: '⚓' },
  { id: 33, type: 'country', name: 'Sao Paulo', alliance: 'BRICS', price: 3000, flag: '🇧🇷', resource: 'tech', rents: [120, 240, 720, 1600, 2000, 2600] },
  { id: 34, type: 'country', name: 'Delhi', alliance: 'SOUTH_ASIAN', price: 2000, flag: '🇮🇳', resource: 'agriculture', rents: [75, 150, 450, 1050, 1300, 1700] },
  { id: 35, type: 'country', name: 'Wellington', alliance: 'PACIFIC_ISLANDS', price: 1600, flag: '🇳🇿', resource: 'agriculture', rents: [65, 130, 400, 950, 1150, 1500] },
  { id: 36, type: 'special', subtype: 'incident', name: 'International Incident', icon: '🚨' },

  // === RIGHT COLUMN (positions 37-47) ===
  { id: 37, type: 'country', name: 'Salvador', alliance: 'BRICS', price: 2800, flag: '🇧🇷', resource: 'agriculture', rents: [110, 220, 660, 1500, 1800, 2400] },
  { id: 38, type: 'country', name: 'Jerusalem', alliance: 'ASIAN_TIGERS', price: 2600, flag: '🇮🇱', resource: 'tech', rents: [100, 200, 600, 1400, 1700, 2200] },
  ...
  { id: 42, type: 'country', name: 'New York', alliance: 'AMERICAS', price: 3200, flag: '🇺🇸', resource: 'agriculture', rents: [130, 260, 780, 1800, 2200, 2800] },
  { id: 43, type: 'country', name: 'Abu Dhabi', alliance: 'OIL_NATIONS', price: 3400, flag: '🇦🇪', resource: 'oil', rents: [140, 280, 840, 1900, 2400, 3000] },
  { id: 44, type: 'country', name: 'Malmo', alliance: 'NORDIC', price: 2200, flag: '🇸🇪', resource: 'tech', rents: [85, 170, 500, 1100, 1400, 1800] },
  { id: 45, type: 'country', name: 'Queenstown', alliance: 'PACIFIC_ISLANDS', price: 2400, flag: '🇳🇿', resource: 'tourism', rents: [90, 180, 540, 1200, 1500, 2000] },
...
export const MAPS = {
  classic: {
    id: 'classic',
    name: 'Classic',
    description: '40 spaces · 22 cities · 8 alliances',
    board: BOARD,
    gridSize: 11,
