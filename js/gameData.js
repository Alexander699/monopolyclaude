...
export const ALLIANCES = {
  ...
  OIL_NATIONS: {
    ...
    color: '#000000',
    lightColor: '#4d4d4d',
    bonus: 'Collect oil royalties: $130/turn',
    resource: 'oil'
  },
  AMERICAS: {
    id: 'AMERICAS',
...
export const BOARD = [
  ...
  { id: 4, type: 'tax', name: 'Import Tariff', amount: 400, icon: '💰' },
  ...
  { id: 38, type: 'tax', name: 'Luxury Tax', amount: 900, icon: '💎' },
...
export const BOARD_EXPANDED = [
  ...
  { id: 46, type: 'tax', name: 'Luxury Tax', amount: 900, icon: '💎' },
