...
export const DEVELOPMENT_TIERS = [
  ...
  { level: 1, name: 'Local Markets', icon: '🏪', multiplier: 2, costMultiplier: 0.4 },
  { level: 2, name: 'Factories', icon: '🏭', multiplier: 3, costMultiplier: 0.6 },
  { level: 3, name: 'Tech Hubs', icon: '🏙️', multiplier: 5, costMultiplier: 0.8 },
  { level: 4, name: 'Economic Capital', icon: '🏛️', multiplier: 8, costMultiplier: 1.2 }
];
...
export const GLOBAL_NEWS_CARDS = [
  { id: 'gn1', title: 'Global Pandemic', text: 'Tourism industry collapses. All tourism cities pay $150 per development level.', effect: 'tourism_penalty', amount: 150 },
  { id: 'gn2', title: 'Oil Price Surge', text: 'Oil prices skyrocket! Oil city owners collect $300 from the bank.', effect: 'oil_bonus', amount: 300 },
  ...
  { id: 'gn4', title: 'Big Yahu Donation', text: 'Big Yahu is proud of the Goyim. Collect $75 per country', effect: 'per_country_bonus', amount: 75 },
  { id: 'gn5', title: 'Trade War', text: 'Tariffs everywhere! All players pay $150 per foreign alliance they own properties in.', effect: 'trade_war_tax', amount: 150 },
  ...
  { id: 'gn7', title: 'Refugee Crisis', text: 'Humanitarian costs. Pay $400 to the bank.', effect: 'pay_bank', amount: 400 },
  { id: 'gn8', title: 'Space Race', text: 'Technological advancement! All Tech Hub developments earn +$150 this round.', effect: 'tech_hub_bonus', amount: 150 },
  ...
  { id: 'gn11', title: 'Agricultural Revolution', text: 'Bumper harvest! Agriculture cities pay owners $200 bonus.', effect: 'agriculture_bonus', amount: 200 },
  { id: 'gn12', title: 'Infrastructure Boom', text: 'Government spending! Each development you own earns $40.', effect: 'per_development_bonus', amount: 40 },
  ...
  { id: 'gn16', title: 'UN Aid Package', text: 'Humanitarian aid! Collect $300 from the bank.', effect: 'collect_bank', amount: 300 },
...
export const DIPLOMATIC_CABLE_CARDS = [
  { id: 'dc1', title: 'Foreign Investment', text: 'A wealthy investor backs your ventures. Collect $750.', effect: 'collect', amount: 750 },
  { id: 'dc2', title: 'Embassy Donation', text: 'Your embassy receives a generous donation. Collect $300.', effect: 'collect', amount: 300 },
  ...
  { id: 'dc5', title: 'Tax Haven', text: 'You discover an offshore account. Collect $150 per property owned.', effect: 'per_property_collect', amount: 150 },
  { id: 'dc6', title: 'Spy Scandal', text: 'Intelligence leak! Pay each player $75.', effect: 'pay_all_players', amount: 75 },
  ...
  { id: 'dc11', title: 'Aid Package', text: 'International aid received. Collect $500.', effect: 'collect', amount: 500 },
  { id: 'dc12', title: 'Election Scandal', text: 'Political crisis at home! Pay $300 in damage control.', effect: 'pay', amount: 300 },
  { id: 'dc13', title: 'Trade Delegation', text: 'Successful delegation! Collect $50 from each player.', effect: 'collect_from_all', amount: 50 },
  { id: 'dc14', title: 'Arms Deal', text: 'Controversial but profitable. Collect $600 but lose 50 influence.', effect: 'arms_deal', collectAmount: 600, influenceLoss: 50 },
  { id: 'dc15', title: 'Cultural Exchange', text: 'Soft power initiative! Gain 50 influence and collect $150.', effect: 'cultural_exchange', influence: 50, amount: 150 },
  { id: 'dc16', title: 'Cyber Attack', text: 'Your systems compromised! Pay $250 in recovery costs.', effect: 'pay', amount: 250 },
  ...
  { id: 'dc18', title: 'Heritage Fund', text: 'Cultural heritage grant! Collect $400.', effect: 'collect', amount: 400 }
];
